    ...
    <div id="storyModal" class="story-modal">
        <div class="story-container">
            ...
            <div class="story-actions">
                ...
                <button class="story-heart">❤️</button>
            ...
            <div class="profile-info">
                <form id="formProfilePic" enctype="multipart/form-data">
                    <label for="profilePicInput">
                        <img id="profileAvatar" src="../../public/img/gambar3.jpg" alt="wellysaverdalena" class="profile-avatar">
                    </label>
...
<body>
    ...
    <script>
        ...
        function closeAddStory() {
            ...
            if (privacyBtn) {
                privacyBtn.innerHTML = '<span class="btn-icon">👁️</span>';
