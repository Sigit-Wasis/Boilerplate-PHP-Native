...
$stories = [
    ...
    [
        'username' => 'wellysaverdalena', 
        'avatar' => '../../public/img/gambar6.jpg',
        'stories' => [
    ...
    [
        'username' => 'saa', 
        'avatar' => '../../public/img/gambar10.jpg',
        'stories' => [
    ...
    [
        'username' => 'ikamaharani', 
        'avatar' => '../../public/img/gambar9.jpg',
        'stories' => [
    ...
    [
        'username' => 'devsptalstr', 
        'avatar' => '../../public/img/gambar13.jpg',
        'stories' => [
...
$suggestions = [
    ['username' => 'wawa', 'avatar' => '../../public/img/gambar14.jpg','mutual' => 'Disarankan untuk Anda'],
    ['username' => 'scndnisa', 'avatar' => '../../public/img/gambar15.jpg', 'mutual' => 'Disarankan untuk Anda'],
    ['username' => 'fara', 'avatar' => '../../public/img/gambar16.jpg', 'mutual' => 'Disarankan untuk Anda'],
    ['username' => 'desyyupita', 'avatar' => '../../public/img/gambar17.jpg', 'mutual' => 'Diikuti oleh mamanx_x'],
    ['username' => 'felandr', 'avatar' => '../../public/img/gambar18.jpg', 'mutual' => 'Diikuti oleh fajridn_']
];
    ...
    <div id="storyModal" class="story-modal">
        <div class="story-container">
            ...
            <div class="story-actions">
                ...
                <button class="story-heart">❤</button>
                <button class="story-share">📤</button>
            </div>
        </div>
    </div>
    ...
    <div id="addStoryModal" class="story-modal add-story-modal">
        <div class="add-story-container">
            <div class="add-story-header">
                <h3>Buat story</h3>
                <button class="story-close" onclick="closeAddStory()">×</button>
            </div>
            ...
            <div class="story-preview" id="storyPreview" style="display: none;">
                ...
                <div class="story-tools-header">
                    <button class="story-tool-btn" onclick="closeAddStory()">✕</button>
                    <button class="story-tool-btn" onclick="toggleBoomerang()">∞</button>
                    <button class="story-tool-btn" onclick="addText()" id="textToolBtn">Aa</button>
                    <button class="story-tool-btn" onclick="addSticker()">😊</button>
                    <button class="story-tool-btn" onclick="addMusic()">♪</button>
                    <button class="story-tool-btn" onclick="addSparkles()">✨</button>
                    <button class="story-tool-btn more-tools" onclick="showMoreTools()">⋯</button>
                </div>
                ...
                <div class="story-text-input-bottom" id="storyTextInputBottom" style="display: none;">
                    ...
                    <div class="text-style-options">
                        ...
                        <button class="text-style-btn" onclick="changeTextStyle('modern')" data-style="modern">𝗔</button>
                        <button class="text-style-btn" onclick="changeTextStyle('neon')" data-style="neon">𝔸</button>
                        <button class="text-style-btn" onclick="changeTextStyle('typewriter')" data-style="typewriter">𝙰</button>
                    </div>
